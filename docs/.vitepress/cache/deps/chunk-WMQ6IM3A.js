// node_modules/vitepress-mermaid-preview/dist/cytoscape.esm-wWJwD64P.js
function Bs(r, e) {
...
function jf(r, e) {
  for (var t = 0; t < e.length; t++) {
    var a = e[t];
    a.enumerable = a.enumerable || false, a.configurable = true, "value" in a && (a.writable = true), Object.defineProperty(r, Ql(a.key), a);
  }
}
function ht(r, e, t) {
  return e && jf(r.prototype, e), Object.defineProperty(r, "prototype", {
    writable: false
  }), r;
}
function kr(r, e) {
...
function rr(r, e) {
  return Qf(r) || rc(r, e) || Xs(r, e) || tc();
}
function mn(r) {
  return Jf(r) || ec(r) || Xs(r) || ac();
}
function nc(r, e) {
...
var er = typeof window > "u" ? null : window;
var To = er ? er.navigator : null;
er && er.document;
var ic = ar("");
var Jl = ar({});
var sc = ar(function() {
});
var oc = typeof HTMLElement > "u" ? "undefined" : ar(HTMLElement);
var La = function(e) {
  return e && e.instanceString && $e(e.instanceString) ? e.instanceString() : null;
};
var de = function(e) {
  return e != null && ar(e) == ic;
};
var $e = function(e) {
  return e != null && ar(e) === sc;
};
var ze = function(e) {
  return !Dr(e) && (Array.isArray ? Array.isArray(e) : e != null && e instanceof Array);
};
var Re = function(e) {
  return e != null && ar(e) === Jl && !ze(e) && e.constructor === Object;
};
var uc = function(e) {
  return e != null && ar(e) === Jl;
};
var te = function(e) {
...
var cc = function(e) {
  return Re(e) && te(e.x1) && te(e.x2) && te(e.y1) && te(e.y2);
};
var dc = function(e) {
  return uc(e) && $e(e.then);
};
var hc = function() {
...
var tr = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))";
var gc = "rgb[a]?\\((" + tr + "[%]?)\\s*,\\s*(" + tr + "[%]?)\\s*,\\s*(" + tr + "[%]?)(?:\\s*,\\s*(" + tr + "))?\\)";
var pc = "rgb[a]?\\((?:" + tr + "[%]?)\\s*,\\s*(?:" + tr + "[%]?)\\s*,\\s*(?:" + tr + "[%]?)(?:\\s*,\\s*(?:" + tr + "))?\\)";
var yc = "hsl[a]?\\((" + tr + ")\\s*,\\s*(" + tr + "[%])\\s*,\\s*(" + tr + "[%])(?:\\s*,\\s*(" + tr + "))?\\)";
var mc = "hsl[a]?\\((?:" + tr + ")\\s*,\\s*(?:" + tr + "[%])\\s*,\\s*(?:" + tr + "[%])(?:\\s*,\\s*(?:" + tr + "))?\\)";
var bc = "\\#[0-9a-fA-F]{3}";
var wc = "\\#[0-9a-fA-F]{6}";
var tv = function(e, t) {
...
var pe = Object.assign != null ? Object.assign.bind(Object) : function(r) {
...
var Cc = function(e) {
  var t, a, n, i, s, o, l, u;
  function v(d, m, g) {
    return g < 0 && (g += 1), g > 1 && (g -= 1), g < 1 / 6 ? d + (m - d) * 6 * g : g < 1 / 2 ? m : g < 2 / 3 ? d + (m - d) * (2 / 3 - g) * 6 : d;
  }
  var f = new RegExp("^" + yc + "$").exec(e);
  if (f) {
...
var av = function(e) {
  return (ze(e) ? e : null) || Sc(e) || Ec(e) || Tc(e) || Cc(e);
};
var kc = {
...
function Ln() {
  if (Bo) return ei;
  Bo = 1;
  var r = Dc(), e = typeof self == "object" && self && self.Object === Object && self, t = r || e || Function("return this")();
  return ei = t, ei;
}
var ri;
var Po;
...
function sv() {
  if (Oo) return oi;
  Oo = 1;
  var r = Qs(), e = Rc(), t = Mc(), a = "[object Null]", n = "[object Undefined]", i = r ? r.toStringTag : void 0;
  function s(o) {
...
function Ic() {
  if (Fo) return vi;
  Fo = 1;
  var r = Ac(), e = Na(), t = za(), a = NaN, n = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, o = parseInt;
  function l(u) {
    if (typeof u == "number")
      return u;
    if (t(u))
...
function Oc() {
  if (Vo) return fi;
  Vo = 1;
  var r = Na(), e = Bc(), t = Ic(), a = "Expected a function", n = Math.max, i = Math.min;
  function s(o, l, u) {
    var v, f, c, h, d, m, g = 0, p = false, y = false, b = true;
    if (typeof o != "function")
      throw new TypeError(a);
    l = t(l) || 0, r(u) && (p = !!u.leading, y = "maxWait" in u, c = y ? n(t(u.maxWait) || 0, l) : c, b = "trailing" in u ? !!u.trailing : b);
    function w(B) {
      var R = v, M = f;
      return v = f = void 0, g = B, h = o.apply(M, R), h;
    }
    function E(B) {
      return g = B, d = setTimeout(T, l), p ? w(B) : h;
    }
    function C(B) {
      var R = B - m, M = B - g, L = l - R;
      return y ? i(L, c - M) : L;
    }
    function x(B) {
      var R = B - m, M = B - g;
      return m === void 0 || R >= l || R < 0 || y && M >= c;
    }
    function T() {
      var B = e();
      if (x(B))
    ...
    function P() {
      d !== void 0 && clearTimeout(d), g = 0, v = m = f = d = void 0;
    }
    function D() {
    ...
    function A() {
      var B = e(), R = x(B);
      if (v = arguments, f = this, m = B, R) {
        if (d === void 0)
          return E(m);
        if (y)
          return clearTimeout(d), d = setTimeout(T, l), w(m);
      }
...
var Nc = Oc();
var Fa = Oa(Nc);
var ci = er ? er.performance : null;
var ov = ci && ci.now ? function() {
  return ci.now();
} : function() {
  return Date.now();
};
var zc = function() {
  if (er) {
    if (er.requestAnimationFrame)
      return function(r) {
        er.requestAnimationFrame(r);
      };
    if (er.mozRequestAnimationFrame)
      return function(r) {
        er.mozRequestAnimationFrame(r);
      };
    if (er.webkitRequestAnimationFrame)
      return function(r) {
        er.webkitRequestAnimationFrame(r);
      };
    if (er.msRequestAnimationFrame)
      return function(r) {
        er.msRequestAnimationFrame(r);
      };
  }
  return function(r) {
...
var Ta = function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Gt;
  return (t << 5) + t + e | 0;
};
var Fc = function(e, t) {
  return e * 2097152 + t;
...
var _o = true;
var qc = console.warn != null;
var _c = console.trace != null;
...
var Ie = function(e) {
  cv() && (qc ? console.warn(e) : (console.log(e), _c && console.trace()));
};
var Gc = function(e) {
  return pe({}, e);
};
var qr = function(e) {
  return e == null ? e : ze(e) ? e.slice() : Re(e) ? Gc(e) : e;
};
var Hc = function(e) {
  return e.slice();
};
...
var ra = (typeof Set > "u" ? "undefined" : ar(Set)) !== Kc ? Set : Xc;
var In = function(e, t) {
  ...
  var u = [];
  ze(t.classes) ? u = t.classes : de(t.classes) && (u = t.classes.split(/\s+/));
  ...
  var h = t.style || t.css;
  h && (Ie("Setting a `style` bypass at element creation should be done only when absolutely necessary.  Try to use the stylesheet instead."), this.style(h));
};
var Ho = function(e) {
  return e = {
    bfs: e.bfs || !e.dfs,
    ...
    var s;
    Re(a) && !Dr(a) && (s = a, a = s.roots || s.root, n = s.visit, i = s.directed), i = arguments.length === 2 && !$e(n) ? n : i, n = $e(n) ? n : function() {
    };
    for (var o = this._private.cy, l = a = de(a) ? this.filter(a) : a, u = [], v = [], f = {}, c = {}, h = {}, d = 0, m, g = this.byGroup(), p = g.nodes, y = g.edges, b = 0; b < l.length; b++) {
      var w = l[b], E = w.id();
    ...
    for (var C = function() {
      ...
      var M = c[R], L = f[R], I = L != null ? L.source() : null, O = L != null ? L.target() : null, F = L == null ? void 0 : B.same(I) ? O[0] : I[0], _;
      if (_ = n(B, L, F, d++, M), _ === true)
        return m = B, 1;
      if (_ === false)
        return 1;
      for (var N = B.connectedEdges().filter(function(J) {
        return (!i || J.source().same(B)) && y.has(J);
      }), q = 0; q < N.length; q++) {
        var U = N[q], X = U.connectedNodes().filter(function(J) {
          return !J.same(B) && p.has(J);
        }), j = X.id();
        X.length !== 0 && !h[j] && (X = X[0], u.push(X), e.bfs && (h[j] = true, v.push(X)), f[j] = U, c[j] = c[R] + 1);
      }
    }, x; u.length !== 0 && (x = C(), !(x !== 0 && x === 1)); )
      ;
    for (var T = o.collection(), S = 0; S < v.length; S++) {
      var P = v[S], D = f[P.id()];
      D != null && T.push(D), T.push(P);
    }
    return {
      path: o.collection(T),
...
function Zc() {
  return Wo || (Wo = 1, function(r, e) {
    (function() {
      var t, a, n, i, s, o, l, u, v, f, c, h, d, m, g;
      n = Math.floor, f = Math.min, a = function(p, y) {
        return p < y ? -1 : p > y ? 1 : 0;
      }, v = function(p, y, b, w, E) {
        var C;
        if (b == null && (b = 0), E == null && (E = a), b < 0)
          throw new Error("lo must be non-negative");
        for (w == null && (w = p.length); b < w; )
          C = n((b + w) / 2), E(y, p[C]) < 0 ? w = C : b = C + 1;
        return [].splice.apply(p, [b, b - b].concat(y)), y;
      }, o = function(p, y, b) {
        return b == null && (b = a), p.push(y), m(p, 0, p.length - 1, b);
      }, s = function(p, y) {
        var b, w;
        return y == null && (y = a), b = p.pop(), p.length ? (w = p[0], p[0] = b, g(p, 0, y)) : w = b, w;
      }, u = function(p, y, b) {
        var w;
        return b == null && (b = a), w = p[0], p[0] = y, g(p, 0, b), w;
      }, l = function(p, y, b) {
        var w;
        return b == null && (b = a), p.length && b(p[0], y) < 0 && (w = [p[0], y], y = w[0], p[0] = w[1], g(p, 0, b)), y;
      }, i = function(p, y) {
        var b, w, E, C, x, T;
        for (y == null && (y = a), C = (function() {
          ...
          b = C[w], x.push(g(p, b, y));
        return x;
      }, d = function(p, y, b) {
        var w;
        if (b == null && (b = a), w = p.indexOf(y), w !== -1)
          return m(p, 0, w, b), g(p, w, b);
      }, c = function(p, y, b) {
        var w, E, C, x, T;
        if (b == null && (b = a), E = p.slice(0, y), !E.length)
          return E;
        for (i(E, b), T = p.slice(y), C = 0, x = T.length; C < x; C++)
          w = T[C], l(E, w, b);
        return E.sort(b).reverse();
      }, h = function(p, y, b) {
        var w, E, C, x, T, S, P, D, A;
        if (b == null && (b = a), y * 10 <= p.length) {
          if (C = p.slice(0, y).sort(b), !C.length)
            return C;
          for (E = C[C.length - 1], P = p.slice(y), x = 0, S = P.length; x < S; x++)
            w = P[x], b(w, E) < 0 && (v(C, w, 0, null, b), C.pop(), E = C[C.length - 1]);
          return C;
        }
        for (i(p, b), A = [], T = 0, D = f(y, p.length); 0 <= D ? T < D : T > D; 0 <= D ? ++T : --T)
          A.push(s(p, b));
        return A;
      }, m = function(p, y, b, w) {
        var E, C, x;
        for (w == null && (w = a), E = p[b]; b > y; ) {
        ...
        var w, E, C, x, T;
        for (b == null && (b = a), E = p.length, T = y, C = p[y], w = 2 * y + 1; w < E; )
          x = w + 1, x < E && !(b(p[w], p[x]) < 0) && (w = x), p[y] = p[w], y = w, w = 2 * y + 1;
        return p[y] = C, m(p, T, y, b);
      }, t = function() {
        ...
        return p.prototype.push = function(y) {
          return o(this.nodes, y, this.cmp);
          ...
          return d(this.nodes, y, this.cmp);
...
var ed = {
  dijkstra: function(e) {
    ...
    var a = jc(e), n = a.root, i = a.weight, s = a.directed, o = this, l = i, u = de(n) ? this.filter(n)[0] : n[0], v = {}, f = {}, c = {}, h = this.byGroup(), d = h.nodes, m = h.edges;
    ...
    for (var g = function(L) {
      ...
      v[L.id()] = I, y.updateItem(L);
    }, y = new Va(function(M, L) {
      return g(M) - g(L);
    }), b = 0; b < d.length; b++) {
      var w = d[b];
      v[w.id()] = w.same(u) ? 0 : 1 / 0, y.push(w);
    }
    for (var E = function(L, I) {
      for (var O = (s ? L.edgesTo(I) : L.edgesWith(I)).intersect(m), F = 1 / 0, _, N = 0; N < O.length; N++) {
        var q = O[N], U = l(q);
        (U < F || !_) && (F = U, _ = q);
      }
      return {
...
var od = {
  ...
  bellmanFord: function(e) {
    var t = this, a = sd(e), n = a.weight, i = a.directed, s = a.root, o = n, l = this, u = this.cy(), v = this.byGroup(), f = v.edges, c = v.nodes, h = c.length, d = new Xr(), m = false, g = [];
    ...
    for (var S = false, P = function(oe, ve, he, ye, me, we) {
      var xe = ye.dist + we;
      xe < me.dist && !he.same(ye.edge) && (me.dist = xe, me.pred = oe, me.edge = he, S = true);
    }, D = 1; D < h; D++) {
      S = false;
      for (var A = 0; A < p; A++) {
    ...
    if (S)
      for (var F = [], _ = 0; _ < p; _++) {
        ...
        if (j + X < J || !i && J + X < j)
          if (m || (Ie("Graph contains a negative weight cycle for Bellman-Ford"), m = true), e.findNegativeWeightCycles !== false) {
            var re = [];
...
var sr = function(e, t, a, n) {
  return (1 - n) * (1 - n) * e + 2 * (1 - n) * n * t + n * n * a;
};
var Ut = function(e, t, a, n) {
  return {
    x: sr(e.x, t.x, a.x, n),
    y: sr(e.y, t.y, a.y, n)
  };
};
var md = function(e, t, a, n) {
  var i = {
    x: t.x - e.x,
    y: t.y - e.y
  }, s = Dt(e, t), o = {
...
var Td = (gi = Math.hypot) !== null && gi !== void 0 ? gi : function(r, e) {
...
var yv = function(e, t, a, n, i, s, o) {
  ...
  if (c) {
    ...
    if (d = nt(e, t, a, n, m, g, p, y, false), d.length > 0)
      return d;
  }
  if (h) {
    var b = a + v + o, w = n - f + u - o, E = b, C = n + f - u + o;
    if (d = nt(e, t, a, n, b, w, E, C, false), d.length > 0)
      return d;
  }
  if (c) {
    var x = a - v + u - o, T = n + f + o, S = a + v - u + o, P = T;
    if (d = nt(e, t, a, n, x, T, S, P, false), d.length > 0)
      return d;
  }
  if (h) {
    var D = a - v - o, A = n - f + u - o, B = D, R = n + f - u + o;
    if (d = nt(e, t, a, n, D, A, B, R, false), d.length > 0)
      return d;
  }
  var M;
  {
...
var Rd = function(e, t, a, n, i, s, o, l) {
...
var Ld = function(e, t, a, n, i, s, o, l) {
...
var nt = function(e, t, a, n, i, s, o, l, u) {
...
var Nd = function(e, t, a, n, i, s, o, l, u) {
  ...
  for (var h = 0; h < c.length / 4; h++)
    f = nt(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], false), f.length !== 0 && v.push(f[0], f[1]);
  if (v.length > 2) {
...
var Yo = function(e) {
  ...
  for (var y = true, b = 0; y && b < i.maxIterations; )
    y = false, f = Kd(v, l, i.expandFactor), v = Xd(f, l, i.inflateFactor), Yd(v, f, u, 4) || (y = true), b++;
  var w = Zd(v, l, t, n);
  return w = Jd(w), w;
};
var jd = {
...
var nh = function(e, t, a) {
  return Math.abs(t - e) <= a;
};
var ih = function(e, t, a) {
    ...
    for (var c = 0; c < i.k; c++) {
      ...
      if (h.length !== 0) {
        for (var d = i.attributes.length, m = l[c], g = new Array(d), p = new Array(d), y = 0; y < d; y++) {
          ...
          g[y] = p[y] / h.length, nh(g[y], m[y], i.sensitivityThreshold) || (u = true);
        }
    ...
    for (var d = 0; d < o.length; d++) {
      ...
      if (m.length !== 0) {
        ...
        for (var g = 0; g < m.length; g++)
          u = jo(m[g], m, i.attributes), u < v[d] && (v[d] = u, o[d] = m[g], f = true);
        s[d] = t.collection(m);
      }
    }
    c++;
...
var eu = function(e) {
  ...
  for (var p = 0; p < a.length; p++)
    u[p] = new Array(n.k);
  for (var y = true, b = 0; y && b < n.maxIterations; )
    y = false, lh(s, a, o, u, n), vh(o, l, s, a, n), ih(o, l, n.sensitivityThreshold) || (y = true), b++;
  return i = fh(a, o, n, t), {
    clusters: i,
...
var ru = function(e, t, a, n, i) {
  ...
  return d.key = m.key = d.index = m.index = null, true;
};
...
var Sh = {
  hierholzer: function(e) {
    ...
    var a = Th(e), n = a.root, i = a.directed, s = this, o = false, l, u, v;
    n && (v = de(n) ? this.filter(n)[0].id() : n[0].id());
    var f = {}, c = {};
    i ? s.forEach(function(y) {
      var b = y.id();
      if (y.isNode()) {
        var w = y.indegree(true), E = y.outdegree(true), C = w - E, x = E - w;
        C == 1 ? l ? o = true : l = b : x == 1 ? u ? o = true : u = b : (x > 1 || C > 1) && (o = true), f[b] = [], y.outgoers().forEach(function(T) {
      ...
      if (y.isNode()) {
        var w = y.degree(true);
        w % 2 && (l ? u ? o = true : u = b : l = b), f[b] = [], y.connectedEdges().forEach(function(E) {
    ...
    for (var p in f)
      if (f[p].length)
        return h;
    return h.found = true, h.trail = this.spawn(m, true), h;
  }
};
var Qa = function() {
  var e = this, t = {}, a = 0, n = 0, i = [], s = [], o = {}, l = function(c, h) {
    ...
    if (m.size() === 0)
      ...
      m.forEach(function(w) {
        g = w.source().id(), p = w.target().id(), y = g === h ? p : g, y !== d && (b = w.id(), o[b] || (o[b] = true, s.push({
          x: h,
          y,
          edge: w
        })), y in t ? t[h].low = Math.min(t[h].low, t[y].id) : (u(c, y, h), t[h].low = Math.min(t[h].low, t[y].low), t[h].id <= t[y].low && (t[h].cutVertex = true, l(h, y))));
      });
    }
  };
  ...
  if (typeof a == "function") {
    ...
    try {
      a.call(
        ...
        function(i) {
          n || (n = true, i === t ? e.reject(new TypeError("circular thenable chain")) : Pv(e, i));
        },
        /*  rejectPromise  */
...
var Is = function(e, t, a) {
  ...
  if (s.target = e, s.style = s.style || s.css, s.started = false, s.playing = false, s.hooked = false, s.applying = false, s.progress = 0, s.completes = [], s.frames = [], s.complete && $e(s.complete) && s.completes.push(s.complete), i) {
    var o = e.position();
...
function tg() {
  if (_u) return Qi;
  _u = 1;
  var r = rg(), e = "Expected a function";
  function t(a, n) {
...
function Rv() {
  if (Hu) return ji;
  Hu = 1;
  var r = ag(), e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, t = /\\(\\)?/g, a = r(function(n) {
    var i = [];
...
function ng() {
  if ($u) return rs;
  $u = 1;
  var r = Qs(), e = Mv(), t = zn(), a = za(), n = r ? r.prototype : void 0, i = n ? n.toString : void 0;
  function s(o) {
    if (typeof o == "string")
      return o;
    if (t(o))
...
function fg() {
  if (ju) return ls;
  ju = 1;
  var r = vg(), e = Av(), t = Object.prototype, a = t.hasOwnProperty;
  function n(i, s, o) {
    var l = i[s];
...
function dg() {
  ...
  function i(s, o, l, u) {
    ...
    for (var v = -1, f = o.length, c = f - 1, h = s; h != null && ++v < f; ) {
      ...
      if (v != c) {
        var g = h[d];
        m = u ? u(g, d, h) : void 0, m === void 0 && (m = a(g) ? g : t(o[v + 1]) ? [] : {});
      }
      r(h, d, m), h = h[d];
    }
    return s;
...
function mg() {
  if (nl) return hs;
  nl = 1;
  var r = Mv(), e = yg(), t = zn(), a = za(), n = Rv(), i = oo(), s = Lv();
  function o(l) {
...
var xg = {
  ...
  data: function(e) {
    ...
    return e = pe({}, t, e), function(n, i) {
      ...
      if (de(n)) {
        var f = n.indexOf(".") !== -1, c = f && wg(n);
        if (s.allowGetting && i === void 0) {
          var h;
          return v && (s.beforeGet(v), c && v._private[s.field][n] === void 0 ? h = ug(v._private[s.field], c) : h = v._private[s.field][n]), h;
          ...
          if (d) {
            ...
            for (var g = 0, p = u.length; g < p; g++) {
              var y = u[g];
              s.canSet(y) && (c && v._private[s.field][n] === void 0 ? pg(y._private[s.field], c, i) : y._private[s.field][n] = i);
            }
            s.updateStyle && o.updateStyle(), s.onSet(o), s.settingTriggersEvent && o[s.triggerFnName](s.settingEvent);
          }
        }
      } else if (s.allowSetting && Re(n)) {
    ...
    return e = pe({}, t, e), function(n) {
      ...
      if (de(n)) {
        ...
        for (var g = 0, p = l.length; g < p; g++)
          for (var y = l[g]._private[i.field], b = Object.keys(y), w = 0; w < b.length; w++) {
...
var Ns = [{
  ...
  populate: function(e, t) {
    if (e.currentSubject != null && e.currentSubject !== t)
      return Ie("Redefinition of subject in selector `" + e.toString() + "`"), false;
    e.currentSubject = t;
...
var Pg = function(e) {
  ...
  for (t.length = 1, a = Bg(a); ; ) {
    var i = Dg(a);
    if (i.expr == null)
      return Ie("The selector `" + e + "`is invalid"), false;
  ...
  for (var u = 0; u < t.length; u++) {
    ...
    if (v.compoundCount > 0 && v.edgeCount > 0)
      return Ie("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), false;
    if (v.edgeCount > 1)
      return Ie("The selector `" + e + "` is invalid because it uses multiple edge selectors"), false;
...
var Ov = function(e, t, a) {
  var n, i = de(e), s = te(e), o = de(a), l, u, v = false, f = false, c = false;
...
var vt = function(e) {
  ...
  }) : de(e) ? this.parse(e) || (this.invalid = true) : We("A selector must be created from a string; found "));
};
var ft = vt.prototype;
...
Or = Vv = {
  ...
  silentShift: function(e, t) {
    return Re(e) ? this.shift(e, true) : de(e) && te(t) && this.shift(e, t, true), this;
  },
...
gt.boundingBox = function(r) {
  var e, t = r === void 0 || r.useCache === void 0 || r.useCache === true, a = Zt(function(v) {
    var f = v._private;
...
var ep = Object.keys(vl).reduce(function(r, e) {
  var t = vl[e], a = jg(e);
  return r[e] = function() {
    return $g(this, t.get);
  }, t.mult ? r[a] = function() {
...
var vp = Hn("parentInteractive", function(r) {
...
var _e = In.prototype = fr.prototype = Object.create(Array.prototype);
...
_e.restore = function() {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.isEdge()) {
      for (var y = h, b = ["source", "target"], w = b.length, E = false, C = 0; C < w; C++) {
        var x = b[C], T = m[x];
        te(T) && (T = m[x] = "" + m[x]), T == null || T === "" ? (We("Can not create edge `" + g + "` with unspecified " + x), E = true) : a.hasElementWithId(T) || (We("Can not create edge `" + g + "` with nonexistant " + x + " `" + T + "`"), E = true);
      }
      if (E) {
        c();
        continue;
  ...
  for (var D = 0; D < i.length; D++) {
    ...
    if (M || A._private.parent) {
      ...
      if (L.empty())
        ...
        for (var I = false, O = L; !O.empty(); ) {
          if (A.same(O)) {
            I = true, B.parent = void 0;
            break;
          }
          O = O.parent();
        }
        I || (L[0]._private.children.push(A), A._private.parent = L[0], n.hasCompoundNodes = true);
      }
    }
  }
  if (o.length > 0) {
...
_e.remove = function() {
  ...
  function l(R) {
    var M = n[R.id()];
    e && R.removed() || M || (n[R.id()] = true, R.isNode() ? (a.push(R), s(R), o(R)) : a.unshift(R));
  }
  ...
  function m(R, M) {
    ...
    ut(L, M), M._private.parent = null, d.ids[I] || (d.ids[I] = true, d.push(R));
  }
...
function da(r, e) {
  return r == null || e == null ? false : te(r) && te(e) ? true : !!(r && e);
}
function yp(r, e, t, a) {
  var n = e._private;
...
function El(r, e) {
  ...
  function n(v, f) {
    var c = v._private, h = c.animation.current, d = c.animation.queue, m = false;
    if (h.length === 0) {
      var g = d.shift();
      g && h.push(g);
    }
    for (var p = function(C) {
      ...
      if (w.stopped) {
        h.splice(y, 1), w.hooked = false, w.playing = false, w.started = false, p(w.frames);
        continue;
      }
      !w.playing && !w.applying || (w.playing && w.applying && (w.applying = false), w.started || yp(v, b, r), pp(v, b, r, f), w.applying && (w.applying = false), p(w.frames), w.step != null && w.step(r), b.completed() && (h.splice(y, 1), w.hooked = false, w.playing = false, w.started = false, p(w.completes)), m = true);
    }
  ...
  for (var s = [], o = {}, l = 0; l < t.length; l++) {
    ...
    if (c || f && h) {
      ...
      for (var m = 0; m < d.length; m++) {
        for (var g = d[m], p = g.name, y = false, b = l + 1; b < t.length; b++) {
          var w = t[b], E = e[b] === wa;
          if (E && (y = w.properties[g.name] != null, y))
            break;
        }
        !o[p] && !y && (o[p] = true, s.push(p));
      }
    }
  }
  return a[n] = s, s;
  ...
  switch (a.mapped) {
    case s.mapData: {
      ...
      if (te(p)) {
        ...
        return Ie("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + p + "` for `" + r.id() + "` is non-numeric)"), false;
    ...
    case s.fn: {
      ...
      if (a.prevFnValue = N, N == null)
        return Ie("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), false;
      if (i = this.parse(a.name, N, a.bypass, c), !i)
        return Ie("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), false;
      i.mapping = qr(a), a = i;
      break;
    }
    case void 0:
...
ur.updateTransitions = function(r, e) {
  ...
  if (n.length > 0 && i > 0) {
    for (var o = {}, l = false, u = 0; u < n.length; u++) {
      ...
      if (c) {
        var h = c.prev, d = h, m = c.next != null ? c.next : f, g = false, p = void 0, y = 1e-6;
        d && (te(d.pfValue) && te(m.pfValue) ? (g = m.pfValue - d.pfValue, p = d.pfValue + y * g) : te(d.value) && te(m.value) ? (g = m.value - d.value, p = d.value + y * g) : ze(d.value) && ze(m.value) && (g = d.value[0] !== m.value[0] || d.value[1] !== m.value[1] || d.value[2] !== m.value[2], p = d.strValue), g && (o[v] = m.strValue, this.applyBypass(r, v, p), l = true));
      }
    }
    if (!l)
      return;
...
_a.applyBypass = function(r, e, t, a) {
  ...
  if (i.length === 0)
    return false;
  for (var y = false, b = 0; b < r.length; b++) {
...
co.appendFromString = function(r) {
  ...
  for (; ; ) {
    ...
    for (var m = []; ; ) {
      ...
      if (!p) {
        Ie("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + h), d = true;
        break;
      }
      s = p[0];
...
(function() {
  ...
  var l = {
    zeroNonZero: function(G, H) {
      return (G == null || H == null) && G !== H || G == 0 && H != 0 ? true : G != 0 && H == 0;
    },
    any: function(G, H) {
      return G != H;
    },
    ...
    triggersBoundsOfParallelEdges: function(G, H, Q) {
      return G === H ? false : Q.pstyle("curve-style").value === "bezier";
    }
  }, {
    name: "visibility",
    type: u.visibility,
    ...
    triggersBoundsOfParallelEdges: function(G, H) {
      return G === H ? false : G === "bezier" || // remove from bundle
      H === "bezier";
    }
  }, {
...
Un.parse = function(r, e, t, a) {
  ...
  var i = a === "mapping" || a === true || a === false || a == null ? "dontcare" : a, s = t ? "t" : "f", o = "" + e, l = vv(r, o, s, i), u = n.propCache = n.propCache || [], v;
...
Un.parseImpl = function(r, e, t, a) {
  ...
  if (u.multiple && a !== "multiple") {
    ...
    if (l ? b = e.split(/\s+/) : ze(e) ? b = e : b = [e], u.evenMultiple && b.length % 2 !== 0)
      return null;
    for (var w = [], E = [], C = [], x = "", T = false, S = 0; S < b.length; S++) {
...
var Pt = {
  ...
  getZoomedViewport: function(e) {
    ...
    if (t.zoomingEnabled || (o = true), te(e) ? s = e : Re(e) && (s = e.level, e.position != null ? i = On(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = true)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !te(s) || s === n || i != null && (!te(i.x) || !te(i.y)))
      return null;
    if (i != null) {
      var l = a, u = n, v = s, f = {
        x: -v / u * (i.x - l.x) + i.x,
  ...
  viewport: function(e) {
    ...
    if (!e)
      return this;
    if (te(e.zoom) || (a = false), Re(e.pan) || (n = false), !a && !n)
      return this;
    if (a) {
      var l = e.zoom;
    ...
    if (n && (!s || !e.cancelOnFailedZoom) && t.panningEnabled) {
      var u = e.pan;
      te(u.x) && (t.pan.x = u.x, o = false), te(u.y) && (t.pan.y = u.y, o = false), o || i.push("pan");
    }
...
var Ra = function(e) {
  ...
  var c = function(d, m, g) {
    ...
    p.length > 0 && p.remove(), d != null && (Re(d) || ze(d)) && t.add(d), t.one("layoutready", function(b) {
      t.notifications(true), t.emit(b), t.one("load", m), t.emitAndNotify("load");
  ...
  v([o.style, o.elements], function(h) {
    ...
    u.styleEnabled && t.style().append(d), c(m, function() {
      t.startAnimationLoop(), u.ready = true, $e(o.ready) && t.on("ready", o.ready);
...
pe(kn, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !bn(e) && bn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = true, t.invalidateSize(), t.initRenderer(pe({}, n, n.renderer, {
...
ef.prototype.run = function() {
  ...
  if (Dr(r.roots))
    ...
    v = e.collection();
    for (var g = function() {
      var ve = m[p], he = ve.maxDegree(false), ye = ve.filter(function(me) {
        return me.degree(false) === he;
      });
      v = v.add(ye);
    }, p = 0; p < m.length; p++)
      g();
  ...
  n.bfs({
    ...
    visit: function(ve, he, ye, me, we) {
      ...
      xe.isChildless() && w(xe, we), b[Pe] = true;
    }
  });
...
Kn.prototype.run = function() {
  ...
  t.stopped = false, (r.animate === true || r.animate === false) && t.emit({
    type: "layoutstart",
    layout: t
  }), r.debug === true ? ms = true : ms = false;
  var a = Ap(e, t, r);
  ms && Mp(a), r.randomize && Lp(a);
  var n = Yr(), i = function() {
    Ip(a, e, r), r.fit === true && e.fit(r.padding);
  }, s = function(c) {
...
var Rp = function(e, t, a) {
  var n = af(e, t, 0, a);
  return 2 > n.count ? 0 : n.graph;
};
var af = function(e, t, a, n) {
  var i = n.graphSet[a];
  ...
  for (var m = 0; m < n.length; m++) {
    ...
    if (g.isNode()) {
      ...
      if (S.edgeType === "bezier" || S.edgeType === "multibezier" || S.edgeType === "self" || S.edgeType === "compound" || S.edgeType === "segments" || S.edgeType === "haystack") {
        for (var P = T.rstyle.bezierPts || T.rstyle.linePts || T.rstyle.haystackPts, D = true, A = 0; A < P.length; A++)
          if (!Ed(c, P[A])) {
            D = false;
            break;
          }
...
yr.findHaystackPoints = function(r) {
  for (var e = 0; e < r.length; e++) {
    ...
    n.haystackPts = n.allpts = [n.source.x * v * m + l.x, n.source.y * c * m + l.y, n.target.x * f * m + u.x, n.target.y * h * m + u.y], n.midX = (n.allpts[0] + n.allpts[2]) / 2, n.midY = (n.allpts[1] + n.allpts[3]) / 2, n.edgeType = "haystack", n.haystack = true, this.storeEdgeProjections(t), this.calculateArrowAngles(t), this.recalculateEdgeLabelProjections(t), this.calculateLabelAngles(t);
  }
};
...
yr.findTaxiPoints = function(r, e) {
  ...
  }, B = A(P, T), R = A(D, S), M = false;
  y === u ? p = Math.abs(B) > Math.abs(R) ? n : a : y === l || y === o ? (p = a, M = true) : (y === i || y === s) && (p = n, M = true);
  var L = p === a, I = L ? R : B, O = L ? D : P, F = to(O), _ = false;
  !(M && (w || C)) && (y === o && O < 0 || y === l && O > 0 || y === i && O > 0 || y === s && O < 0) && (F *= -1, I = F * Math.abs(I), _ = true);
  var N;
  if (w) {
    var q = E < 0 ? 1 + E : E;
    N = q * I;
...
Ga.findEndpoints = function(r) {
  ...
  y.startX = le[0], y.startY = le[1], y.arrowStartX = fe[0], y.arrowStartY = fe[1], P && (!te(y.startX) || !te(y.startY) || !te(y.endX) || !te(y.endY) ? y.badLine = true : y.badLine = false);
};
...
`)), s("labelWrapKey", l);
    ...
    var L = r.pstyle("text-max-width").pfValue, I = "", O = "…", F = false;
...
yf.getNodeShape = function(r) {
  ...
  if (t === "cutrectangle" && (r.width() < Ml || r.height() < Ml))
    return Ll || (Ie("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Ll = true), "rectangle";
  if (r.isParent())
...
ia.load = function() {
  ...
  var S = function() {
    ...
    for (var V = r.findContainerClientCoords(), W = V[0], $ = V[1], K = V[2], se = V[3], ee = k.touches ? k.touches : [k], fe = false, le = 0; le < ee.length; le++) {
      var ge = ee[le];
    ...
    if (!fe)
      return false;
    for (var Te = r.container, Ee = k.target, ce = Ee.parentNode, De = false; ce; ) {
      if (ce === Te) {
        De = true;
        break;
      }
  ...
  r.registerBinding(r.container, "mousedown", function(k) {
    if (P(k) && !(r.hoverData.which === 1 && k.which !== 1)) {
      k.preventDefault(), b(), r.hoverData.capture = true, r.hoverData.which = k.which;
      var V = r.cy, W = [k.clientX, k.clientY], $ = r.projectIntoViewport(W[0], W[1]), K = r.selection, se = r.findNearestElements($[0], $[1], true, false), ee = se[0], fe = r.dragData.possibleDragElements;
      ...
      if (k.which == 3) {
        ...
        ee ? (ee.activate(), ee.emit(Te), r.hoverData.down = ee) : V.emit(Te), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = false;
      } else if (k.which == 1) {
        ee && ee.activate();
        {
        ...
        n(ee, ["mousedown", "tapstart", "vmousedown"], k, {
          ...
          x: $[0],
          y: $[1]
        }, r.redrawHint("select", true), r.redraw()) : ee.pannable() && (K[4] = 1), ge();
      }
      K[0] = K[2] = $[0], K[1] = K[3] = $[1];
    }
  }, false);
  ...
  r.registerBinding([e, D], "mousemove", function(k) {
    ...
    if (!(!V && !P(k))) {
      var W = false, $ = r.cy, K = $.zoom(), se = [k.clientX, k.clientY], ee = r.projectIntoViewport(se[0], se[1]), fe = r.hoverData.mdownPos, le = r.hoverData.mdownGPos, ge = r.selection, Te = null;
      !r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (Te = r.findNearestElement(ee[0], ee[1], true, false));
      ...
      W = true, n(Te, ["mousemove", "vmousemove", "tapdrag"], k, {
        x: ee[0],
        y: ee[1]
      });
      var Ze = function(Br) {
        ...
        r.data.bgActivePosistion = void 0, r.hoverData.selecting || $.emit(Ze("boxstart")), ge[4] = 1, r.hoverData.selecting = true, r.redrawHint("select", true), r.redraw();
      };
      if (r.hoverData.which === 3) {
        if (Je) {
          var $r = Ze("cxtdrag");
          ce ? ce.emit($r) : $.emit($r), r.hoverData.cxtDragged = true, (!r.hoverData.cxtOver || Te !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit(Ze("cxtdragout")), r.hoverData.cxtOver = Te, Te && Te.emit(Ze("cxtdragover")));
        }
        ...
        if (W = true, $.panningEnabled() && $.userPanningEnabled()) {
          ...
          $.panBy(Lt), $.emit(Ze("dragpan")), r.hoverData.dragged = true;
        }
        ...
        if (Je) {
          if (!r.hoverData.dragging && $.boxSelectionEnabled() && (lr || !$.panningEnabled() || !$.userPanningEnabled()))
            ...
            mt && (r.hoverData.dragging = true, r.hoverData.justStartedPan = true, ge[4] = 0, r.data.bgActivePosistion = Ht(fe), r.redrawHint("select", true), r.redraw());
          }
        ...
        if (ce && ce.pannable() && ce.active() && ce.unactivate(), (!ce || !ce.grabbed()) && Te != Ee && (Ee && n(Ee, ["mouseout", "tapdragout"], k, {
          ...
          if (Je) {
            if ($.boxSelectionEnabled() && lr)
              ...
              Er && r.redrawHint("eles", true), r.dragData.didDrag = true, r.hoverData.draggingEles || m(Se, {
                inDragLayer: true
              });
              var hr = {
                x: 0,
              ...
              r.hoverData.draggingEles = true, Se.silentShift(hr).emit(Ze("position")).emit(Ze("drag")), r.redrawHint("drag", true), r.redraw();
            }
          } else
            jr();
        W = true;
      ...
      if (ge[2] = ee[0], ge[3] = ee[1], W)
        return k.stopPropagation && k.stopPropagation(), k.preventDefault && k.preventDefault(), false;
    }
  }, false);
  var A, B, R;
  r.registerBinding(e, "mouseup", function(k) {
    if (!(r.hoverData.which === 1 && k.which !== 1 && r.hoverData.capture)) {
      ...
      if (V) {
        ...
        var W = r.cy, $ = r.projectIntoViewport(k.clientX, k.clientY), K = r.selection, se = r.findNearestElement($[0], $[1], true, false), ee = r.dragData.possibleDragElements, fe = r.hoverData.down, le = i(k);
        ...
        if (r.hoverData.which === 3) {
          ...
          !r.hoverData.isOverThresholdDrag && (n(fe, ["click", "tap", "vclick"], k, {
            x: $[0],
            y: $[1]
          }), B = false, k.timeStamp - R <= W.multiClickDebounceTime() ? (A && clearTimeout(A), B = true, R = null, n(fe, ["dblclick", "dbltap", "vdblclick"], k, {
            x: $[0],
            y: $[1]
          ...
          }, W.multiClickDebounceTime()), R = k.timeStamp)), fe == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(k) && (W.$(t).unselect(["tapunselect"]), ee.length > 0 && r.redrawHint("eles", true), r.dragData.possibleDragElements = ee = W.collection()), se == fe && !r.dragData.didDrag && !r.hoverData.selecting && se != null && se._private.selectable && (r.hoverData.dragging || (W.selectionType() === "additive" || le ? se.selected() ? se.unselect(["tapunselect"]) : se.select(["tapselect"]) : le || (W.$(t).unmerge(se).unselect(["tapunselect"]), se.select(["tapselect"]))), r.redrawHint("eles", true)), r.hoverData.selecting) {
            var ce = W.collection(r.getAllInBox(K[0], K[1], K[2], K[3]));
            r.redrawHint("select", true), ce.length > 0 && r.redrawHint("eles", true), W.emit(ge("boxend"));
            var De = function(Ue) {
          ...
          if (r.hoverData.dragging && (r.hoverData.dragging = false, r.redrawHint("select", true), r.redrawHint("eles", true), r.redraw()), !K[4]) {
        ...
        K[4] = 0, r.hoverData.down = null, r.hoverData.cxtStarted = false, r.hoverData.draggingEles = false, r.hoverData.selecting = false, r.hoverData.isOverThresholdDrag = false, r.dragData.didDrag = false, r.hoverData.dragged = false, r.hoverData.dragDelta = [], r.hoverData.mdownPos = null, r.hoverData.mdownGPos = null, r.hoverData.which = null;
      }
    }
  }, false);
  ...
  r.registerBinding(r.container, "wheel", N, true), r.registerBinding(e, "scroll", function(k) {
    r.scrollingPage = true, clearTimeout(r.scrollingPageTimeout), r.scrollingPageTimeout = setTimeout(function() {
      r.scrollingPage = false;
    }, 250);
  }, true), r.registerBinding(r.container, "gesturestart", function(k) {
    r.gestureStartZoom = r.cy.zoom(), r.hasTouchStarted || k.preventDefault();
  }, true), r.registerBinding(r.container, "gesturechange", function(Y) {
    r.hasTouchStarted || N(Y);
  }, true), r.registerBinding(r.container, "mouseout", function(k) {
  ...
  }, false), r.registerBinding(r.container, "mouseover", function(k) {
    var V = r.projectIntoViewport(k.clientX, k.clientY);
    r.cy.emit({
      originalEvent: k,
      type: "mouseover",
    ...
    if (r.hasTouchStarted = true, !!P(k)) {
      ...
      if (k.touches[1]) {
        ...
        if (re < Te && !k.touches[2]) {
          var Ee = r.findNearestElement(W[0], W[1], true, true), ce = r.findNearestElement(W[2], W[3], true, true);
          Ee && Ee.isNode() ? (Ee.activate().emit(se("cxttapstart")), r.touchData.start = Ee) : ce && ce.isNode() ? (ce.activate().emit(se("cxttapstart")), r.touchData.start = ce) : V.emit(se("cxttapstart")), r.touchData.start && (r.touchData.start._private.grabbed = false), r.touchData.cxt = true, r.touchData.cxtDragged = false, r.data.bgActivePosistion = void 0, r.redraw();
          return;
        }
      }
      if (k.touches[2])
        ...
        if (k.touches[0]) {
          var De = r.findNearestElements(W[0], W[1], true, true), Se = De[0];
          if (Se != null && (Se.activate(), r.touchData.start = Se, r.touchData.starts = De, r.nodeIsGrabbable(Se))) {
            ...
            r.redrawHint("eles", true), r.redrawHint("drag", true), Se.selected() ? (Ue = V.$(function(je) {
          ...
          n(Se, ["touchstart", "tapstart", "vmousedown"], k, {
            ...
            r.touchData.singleTouchMoved === false && !r.pinching && !r.touchData.selecting && n(r.touchData.start, ["taphold"], k, {
              x: W[0],
              y: W[1]
            });
          }, r.tapholdDuration);
  ...
  r.registerBinding(e, "touchmove", oe = function(k) {
    ...
    if (!(!V && !P(k))) {
      ...
      if (V && r.touchData.cxt) {
        var mt = le("cxtdrag");
        r.data.bgActivePosistion = void 0, r.redrawHint("select", true), r.touchData.start ? r.touchData.start.emit(mt) : $.emit(mt), r.touchData.start && (r.touchData.start._private.grabbed = false), r.touchData.cxtDragged = true;
        var Er = r.findNearestElement(K[0], K[1], true, true);
        ...
        k.preventDefault(), r.data.bgActivePosistion = void 0, this.lastThreeTouch = +/* @__PURE__ */ new Date(), r.touchData.selecting || $.emit(le("boxstart")), r.touchData.selecting = true, r.touchData.didSelect = true, W[4] = 1, !W || W.length === 0 || W[0] === void 0 ? (W[0] = (K[0] + K[2] + K[4]) / 3, W[1] = (K[1] + K[3] + K[5]) / 3, W[2] = (K[0] + K[2] + K[4]) / 3 + 1, W[3] = (K[1] + K[3] + K[5]) / 3 + 1) : (W[2] = (K[0] + K[2] + K[4]) / 3, W[3] = (K[1] + K[3] + K[5]) / 3), r.redrawHint("select", true), r.redraw();
        ...
        if (ne) {
          ...
          }), $.emit(le("pinchzoom")), J = wo, q = Ye, U = ir, X = je, j = lr, r.pinching = true;
        }
        if (k.touches[0]) {
          var fe = r.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
          K[0] = fe[0], K[1] = fe[1];
        ...
        if (!r.hoverData.draggingEles && !r.swipePanning && (Er = r.findNearestElement(K[0], K[1], true, true)), V && Mr != null && k.preventDefault(), V && Mr != null && r.nodeIsDraggable(Mr))
          if (Te) {
            ...
            r.hoverData.draggingEles = true, hr.silentShift(la).emit(le("position")).emit(le("drag")), r.redrawHint("drag", true), r.touchData.startPosition[0] == se[0] && r.touchData.startPosition[1] == se[1] && r.redrawHint("eles", true), r.redraw();
          } else {
        ...
        if (n(Mr || Er, ["touchmove", "tapdrag", "vmousemove"], k, {
          ...
          for (var Cr = 0; Cr < K.length; Cr++)
            K[Cr] && r.touchData.startPosition[Cr] && Te && (r.touchData.singleTouchMoved = true);
        if (V && (Mr == null || Mr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
          ...
          Yf && (k.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Ht(r.touchData.startPosition)), r.swipePanning ? ($.panBy({
            x: Ee[0] * ee,
            y: Ee[1] * ee
          }), $.emit(le("dragpan"))) : Te && (r.swipePanning = true, $.panBy({
            x: De * ee,
            y: Je * ee
      ...
      for (var ce = 0; ce < K.length; ce++)
        se[ce] = K[ce];
      V && k.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", true), r.redraw());
    }
  }, false);
  var ve;
  r.registerBinding(e, "touchcancel", ve = function(k) {
    var V = r.touchData.start;
    r.touchData.capture = false, V && V.unactivate();
  });
  var he, ye, me, we;
  if (r.registerBinding(e, "touchend", he = function(k) {
    var V = r.touchData.start, W = r.touchData.capture;
    if (W)
      k.touches.length === 0 && (r.touchData.capture = false), k.preventDefault();
    else
      return;
    var $ = r.selection;
    ...
    if (!k.touches[2] && K.boxSelectionEnabled() && r.touchData.selecting) {
      ...
      $[0] = void 0, $[1] = void 0, $[2] = void 0, $[3] = void 0, $[4] = 0, r.redrawHint("select", true), K.emit(ge("boxend"));
      var De = function($r) {
        return $r.selectable() && !$r.selected();
      };
      ce.emit(ge("box")).stdFilter(De).select().emit(ge("boxselect")), ce.nonempty() && r.redrawHint("eles", true), r.redraw();
    }
    if (V == null ? void 0 : V.unactivate(), k.touches[2])
      ...
      if (!k.touches[0]) {
        if (!k.touches[0]) {
          ...
          if (V != null) {
            ...
            p(Se), r.redrawHint("drag", true), r.redrawHint("eles", true), Je && (V.emit(ge("freeon")), Se.emit(ge("free")), r.dragData.didDrag && (V.emit(ge("dragfreeon")), Se.emit(ge("dragfree")))), n(V, ["touchend", "tapend", "vmouseup", "tapdragout"], k, {
              x: ee[0],
              y: ee[1]
            }), V.unactivate(), r.touchData.start = null;
          } else {
            var Ue = r.findNearestElement(ee[0], ee[1], true, true);
          ...
          r.touchData.singleTouchMoved || (V || K.$(":selected").unselect(["tapunselect"]), n(V, ["tap", "vclick"], k, {
            x: ee[0],
            y: ee[1]
          }), ye = false, k.timeStamp - we <= K.multiClickDebounceTime() ? (me && clearTimeout(me), ye = true, we = null, n(V, ["dbltap", "vdblclick"], k, {
            x: ee[0],
            y: ee[1]
          ...
          }, K.multiClickDebounceTime()), we = k.timeStamp)), V != null && !r.dragData.didDrag && V._private.selectable && jr < r.touchTapThreshold2 && !r.pinching && (K.selectionType() === "single" ? (K.$(t).unmerge(V).unselect(["tapunselect"]), V.select(["tapselect"])) : V.selected() ? V.unselect(["tapunselect"]) : V.select(["tapselect"]), r.redrawHint("eles", true)), r.touchData.singleTouchMoved = true;
        }
      }
    }
...
Qr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, l) {
      var u = e - (a / 2 + o), v = t - (n / 2 + o), f = v, c = e + (a / 2 + o), h = nt(i, s, e, t, u, v, c, f, false);
...
nr.recycleTexture = function(r, e) {
  for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e)
      return s.retired = false, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, eo(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), ut(n, s), a.push(s), s;
  }
};
...
var Cf = function(e) {
  ...
  t.layersByLevel = {}, t.firstGet = true, t.lastInvalidationTime = Yr() - 2 * Nl, t.skipping = false, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Fa(function() {
    t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
  }, by), a.beforeRender(function(s, o) {
    o - t.lastInvalidationTime <= Nl ? t.skipping = true : t.skipping = false;
...
dr.drawEleInLayer = function(r, e, t, a) {
  ...
  o.w === 0 || o.h === 0 || !e.visible() || (t = n.getEleLevelForLayerLevel(t, a), i.setImgSmoothing(s, false), i.drawCachedElement(s, e, null, null, t, ky), i.setImgSmoothing(s, true));
};
...
dr.invalidateLayer = function(r) {
  if (this.lastInvalidationTime = Yr(), !r.invalid) {
    ...
    ut(a, r), r.elesQueue = [], r.invalid = true, r.replacement && (r.replacement.invalid = true);
  ...
  if (!(u.w === 0 || u.h === 0)) {
    ...
    if (v != null) {
      ...
      if (c !== 0) {
        ...
        p = h, y = d;
      var T;
      f !== 1 && (T = r.globalAlpha, r.globalAlpha = T * f), r.drawImage(v.texture.canvas, v.x, 0, v.width, v.height, p, y, m, g), f !== 1 && (r.globalAlpha = T), c !== 0 && (r.rotate(-c), r.translate(-b, -w), E || l.setImgSmoothing(r, false));
    } else
      t.drawElement(r, e);
  }
};
...
Jr.drawArrowShape = function(r, e, t, a, n, i, s, o, l) {
  ...
  if (v) {
    ...
    w != null ? (c = e = w, f = true) : (c = e = new Path2D(), y[b] = c);
  }
...
mo.drawInscribedImage = function(r, e, t, a, n) {
  ...
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? P = v(t, "background-width", "pfValue", a) * g : P = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? D = v(t, "background-height", "pfValue", a) * p : D = v(t, "background-height", "pfValue", a)), !(P === 0 || D === 0)) {
    ...
    var U = r.globalAlpha;
    r.globalAlpha = E;
    var X = i.getImgSmoothing(r), j = false;
    if (C === "no" && X ? (i.setImgSmoothing(r, false), j = true) : C === "yes" && !X && (i.setImgSmoothing(r, true), j = true), c === "no-repeat")
...
pt.drawNode = function(r, e, t) {
  ...
  if (!(!te(f.x) || !te(f.y)) && !(i && !e.visible())) {
    var c = i ? e.effectiveOpacity() : 1, h = s.usePaths(), d, m = false, g = e.padding();
    ...
    var ae = function() {
      ...
      var W = s.nodePathCache = s.nodePathCache || [], $ = vv(k === "polygon" ? k + "," + V.join(",") : k, "" + Y, "" + ue, "" + re), K = W[$], se, ee = false;
      return K != null ? (se = K, ee = true, v.pathCache = se) : (se = new Path2D(), W[$] = v.pathCache = se), {
        path: se,
        cacheHit: ee
      };
    ...
    var be = function() {
      ...
      for (var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true, k = u.backgrounding, V = 0, W = 0; W < E.length; W++) {
      ...
      u.backgrounding = V !== C, k !== u.backgrounding && e.updateStyle(false);
    }, Be = function() {
      var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
    ...
    if (Pe) {
      ...
      r.translate(Ve, Xe), z(), ye(), ae(Oe * B), be(), Fe(He, true), Z(Oe * N), he(), Be(D !== 0 || A !== 0), oe(D !== 0 || A !== 0), Fe(He, false), ve(He), r.translate(-Ve, -Xe);
    }
    h && r.translate(-f.x, -f.y), we(), h && r.translate(f.x, f.y), z(), ye(), ae(), be(), Fe(c, true), Z(), he(), Be(D !== 0 || A !== 0), oe(D !== 0 || A !== 0), Fe(c, false), ve(), h && r.translate(-f.x, -f.y), xe(), me(), t && r.translate(p.x1, p.y1);
  }
};
var kf = function(e) {
  if (!["overlay", "underlay"].includes(e))
...
pt.drawPie = function(r, e, t, a) {
  ...
  if (m && (l = 0, u = 0), i.units === "%" ? c = c * i.pfValue : i.pfValue !== void 0 && (c = i.pfValue / 2), s.units === "%" ? h = c * s.pfValue : s.pfValue !== void 0 && (h = s.pfValue / 2), !(h >= c))
    for (var g = 1; g <= n.pieBackgroundN; g++) {
      ...
      p === 0 || d >= 1 || d + w > 1 || (h === 0 ? (r.beginPath(), r.moveTo(l, u), r.arc(l, u, c, E, x), r.closePath()) : (r.beginPath(), r.arc(l, u, c, E, x), r.arc(l, u, h, x, E, true), r.closePath()), this.colorFillStyle(r, y[0], y[1], y[2], b), r.fill(), d += w);
    }
};
...
xr.render = function(r) {
  ...
  if (f || (e.textureDrawLastFrame = false), f) {
    ...
    var b = t.zoom();
    A(R, false), R.clearRect(x.mpan.x, x.mpan.y, x.width / x.zoom / l, x.height / x.zoom / l), R.drawImage(M, x.mpan.x, x.mpan.y, x.width / x.zoom / l, x.height / x.zoom / l);
  ...
  if (N[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = true), N[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = true), v[e.NODE] || n || i || N[e.NODE]) {
    ...
    A(R, U), _ ? e.drawCachedNodes(R, P.nondrag, l, O) : e.drawLayeredElements(R, P.nondrag, l, O), e.debug && e.drawDebugPoints(R, P.nondrag), !n && !c && (v[e.NODE] = false);
  }
  if (!i && (v[e.DRAG] || n || N[e.DRAG])) {
    var q = c && !N[e.DRAG] && h !== 1, R = a || (q ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : u.contexts[e.DRAG]);
    A(R, c && !q ? "motionBlur" : void 0), _ ? e.drawCachedNodes(R, P.drag, l, O) : e.drawCachedElements(R, P.drag, l, O), e.debug && e.drawDebugPoints(R, P.drag), !n && !c && (v[e.DRAG] = false);
  }
  if (this.drawSelectionRectangle(r, A), c && h !== 1) {
    ...
    (v[e.NODE] || N[e.NODE]) && (ae(X, j, N[e.NODE]), v[e.NODE] = false), (v[e.DRAG] || N[e.DRAG]) && (ae(J, re, N[e.DRAG]), v[e.DRAG] = false);
  }
...
var Jy = function() {
  function r(e, t, a, n) {
    dt(this, r), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = t, this.texRows = a, this.texHeight = Math.floor(t / a), this.enableWrapping = true, this.locked = false, this.texture = null, this.needsBuffer = true, this.freePointer = {
      x: 0,
      row: 0
  ...
  return ht(r, [{
    ...
    key: "bufferIfNeeded",
    value: function(t) {
      this.texture || (this.texture = $y(t, this.debugID)), this.needsBuffer && (this.texture.buffer(this.canvas), this.needsBuffer = false, this.locked && (this.canvas = null, this.scratch = null));
    }
  }, {
    key: "dispose",
    value: function() {
              ...
              var y = function() {
                ...
                if (v(E)) {
                  ...
                  if (s)
                    ...
                    D !== void 0 && !Hy(T, D) && (f = true, a.typeAndIdToKey.delete(P), D.forEach(function(A) {
                      return C.markKeyForGC(A);
                    }));
                  }
                }
    ...
    */
      ...
      if (this._isVisible(t, o)) {
        ...
        try {
          for (v.s(); !(f = v.n()).done; ) {
            ...
            for (var g = s.getAtlasIndexForBatch(h), p = 0, y = [[d, true], [m, false]]; p < y.length; p++) {
    ...
    value: function() {
      ...
      if (i !== 0) {
        ...
        t.uniform1f(s.uZoom, qy(this.r)), t.uniformMatrix3fv(s.uPanZoomMatrix, false, this.panZoomMatrix), t.uniform1i(s.uAtlasSize, this.batchManager.getAtlasSize());
...
function pm(r, e, t, a, n) {
  ...
  p.bindFramebuffer(p.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (p.viewport(0, 0, p.canvas.width, p.canvas.height), Mf(r, null, Ea.PICKING), r.pickingFrameBuffer.needsDraw = false);
  ...
  if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && dm(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
    ...
    if (i = l.length, n.startFrame(o, t), t.screen) {
      ...
      for (var f = 0; f < l.length; f++)
        Ds(r, f, l[f]);
    n.endFrame(), t.screen && r.webglDebugShowAtlases && (hm(r), gm(r)), r.data.canvasNeedsRedraw[r.NODE] = false, r.data.canvasNeedsRedraw[r.DRAG] = false;
  }
  if (r.webglDebug) {
    var c = performance.now(), h = false, d = Math.ceil(c - a), m = n.getDebugInfo(), g = ["".concat(i, " elements"), "".concat(m.totalInstances, " instances"), "".concat(m.batchCount, " batches"), "".concat(m.totalAtlases, " atlases"), "".concat(m.wrappedCount, " wrapped textures"), "".concat(m.simpleCount, " simple shapes")].join(", ");
    if (h)
...
var Us = {};
var Lf = Math.PI / 40;
for (_t = 0 * Math.PI; _t < 2 * Math.PI; _t += Lf)
...
function Nf(r) {
  ...
  for (var u = 0; u < Ce.CANVAS_LAYERS; u++) {
    ...
    e.data.contexts[u] = v.getContext(f), e.data.contexts[u] || We("Could not create canvas of type " + f), Object.keys(l).forEach(function(Z) {
      v.style[Z] = l[Z];
    }), v.style.position = "absolute", v.setAttribute("data-id", "layer" + u), v.style.zIndex = String(Ce.CANVAS_LAYERS - u), e.data.canvasContainer.appendChild(v), e.data.canvasNeedsRedraw[u] = false;
  }
  ...
  var c = wr(), h = function(z) {
    ...
    return e.drawElement(z, G, H, false, false, ne);
...
vitepress-mermaid-preview/dist/cytoscape.esm-wWJwD64P.js:
  (*!
...
*/
//# sourceMappingURL=chunk-WMQ6IM3A.js.map
