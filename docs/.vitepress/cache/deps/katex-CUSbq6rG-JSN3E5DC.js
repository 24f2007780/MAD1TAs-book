...
// node_modules/vitepress-mermaid-preview/dist/katex-CUSbq6rG.js
var u0 = class _u0 {
...
var te = 6;
var n0 = 7;
var y0 = [new O0(ft, 0, false), new O0(Te, 0, true), new O0(ee, 1, false), new O0(B0, 1, true), new O0(le, 2, false), new O0(d0, 2, true), new O0(te, 3, false), new O0(n0, 3, true)];
var za = [le, d0, le, d0, te, n0, te, n0];
var Aa = [d0, d0, d0, d0, n0, n0, n0, n0];
var Ta = [ee, B0, le, d0, te, n0, te, n0];
var Ba = [B0, B0, d0, d0, n0, n0, n0, n0];
var Da = [Te, Te, B0, B0, d0, d0, n0, n0];
var Ca = [ft, Te, ee, B0, ee, B0, ee, B0];
var R = {
  DISPLAY: y0[ft],
  TEXT: y0[ee],
  SCRIPT: y0[le],
...
function pt(r5, e, t) {
  ...
  if (!n && r5[0] in Ot && (a = Ot[r5[0]].charCodeAt(0), n = x0[e][a]), !n && t === "text" && gr(a) && (n = x0[e][77]), n)
    return {
      depth: n[0],
      height: n[1],
      italic: n[2],
...
var T0 = class _T0 {
   ...
   */
  constructor(e) {
    this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || _T0.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = Ht[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0;
  }
  /**
  ...
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = Lt(_T0.BASESIZE, e);
    return this.size === t && this.textSize === _T0.BASESIZE && this.style === e ? this : this.extend({
      style: e,
      size: t
    });
  }
   ...
   */
  baseSizingClasses() {
    return this.size !== _T0.BASESIZE ? ["sizing", "reset-size" + this.size, "size" + _T0.BASESIZE] : [];
  }
  /**
...
var r1 = (r5, e) => {
  if (P0(r5.classes) !== P0(e.classes) || r5.skew !== e.skew || r5.maxFontSize !== e.maxFontSize)
    return false;
...
var Sr = (r5, e, t, a) => new he(r5, e, t, a);
...
var N0 = b.makeSpan;
var d1 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"];
var f1 = ["rightmost", "mrel", "mclose", "mpunct"];
var p1 = {
  display: R.DISPLAY,
  text: R.TEXT,
  script: R.SCRIPT,
...
var y1 = function(e, t, a) {
  var n = Cr(a), s;
  if (a.output === "mathml")
    return Wt(e, t, n, a.displayMode, true);
  if (a.output === "html") {
    var o = ut(e, n);
...
var T1 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r5) => "\\" + r5).join("|"));
B({
  type: "accent",
...
B({
  ...
  htmlBuilder: (r5, e) => {
    var t = P(r5.base, e), a = q0.svgSpan(r5, e), n = r5.label === "\\utilde" ? 0.12 : 0, s = b.makeVList({
      positionType: "top",
...
var Zt = (r5) => r5.type === "textord" && r5.text === "@";
var C1 = (r5, e) => (r5.type === "mathord" || r5.type === "atom") && r5.text === e;
function N1(r5, e, t) {
  var a = D1[r5];
  switch (a) {
    case "\\\\cdrightarrow":
...
var F1 = ["|", "\\lvert", "\\rvert", "\\vert"];
var O1 = ["\\|", "\\lVert", "\\rVert", "\\Vert"];
var Gr = function(e, t, a, n, s, o) {
  var h, c, p, g, y = "", w = 0;
  h = p = g = e, c = null;
  var x = "Size1-Regular";
...
var Vr = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"];
var L1 = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"];
var Ur = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"];
var se = [0, 1.2, 1.8, 2.4, 3];
var P1 = function(e, t, a, n, s) {
  if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), q.contains(Vr, e) || q.contains(Ur, e))
    return Pr(e, t, false, a, n, s);
  if (q.contains(L1, e))
    return Gr(e, se[t], false, a, n, s);
...
var X1 = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
function Fe(r5, e) {
  var t = Re(r5);
...
B({
  ...
  handler: (r5, e) => {
    ...
    return {
      type: "delimsizing",
      mode: r5.parser.mode,
      size: Kt[r5.funcName].size,
      mclass: Kt[r5.funcName].mclass,
      delim: t.text
    };
  },
  htmlBuilder: (r5, e) => r5.delim === "." ? b.makeSpan([r5.mclass]) : D0.sizedDelim(r5.delim, r5.size, e, r5.mode, [r5.mclass]),
  mathmlBuilder: (r5) => {
    var e = [];
...
B({
  ...
  htmlBuilder: (r5, e) => {
    ...
    var h;
    if (r5.left === "." ? h = oe(e, ["mopen"]) : h = D0.leftRightDelim(r5.left, a, n, e, r5.mode, ["mopen"]), t.unshift(h), s)
...
var S0 = function(e, t) {
  ...
  if (e.tags && e.tags.some((fe) => fe))
    for (a = 0; a < s; ++a) {
      ...
      I0 === true ? F0 = b.makeSpan(["eqn-num"], [], t) : I0 === false ? F0 = b.makeSpan([], [], t) : F0 = b.makeSpan([], t0(I0, t, true), t), F0.depth = Z0.depth, F0.height = Z0.height, j0.push({
        type: "elem",
        elem: F0,
        shift: Le
      });
...
var M0 = function(e, t) {
  ...
  if (e.cols && e.cols.length > 0) {
    ...
    for (var O = N; O < F; O++)
      z[O].type === "align" ? (x += $1[z[O].align], C && (T += "none "), C = true) : z[O].type === "separator" && C && (T += z[O].separator === "|" ? "solid " : "dashed ", C = false);
...
k0({
  ...
  handler(r5, e) {
    ...
    if (s = U0(r5.parser, s, "script"), s.body.length > 0 && s.body[0].length > 1)
      throw new M("{subarray} can contain only one column");
    return s;
  },
  htmlBuilder: S0,
...
k0({
  ...
  handler(r5) {
    ...
    }, t = U0(r5.parser, e, At(r5.envName));
    return {
      type: "leftright",
      mode: r5.mode,
      body: [t],
...
B({
  ...
  handler(r5, e) {
    var {
      parser: t
    } = r5, a = e[4], n = e[5], s = Ne(e[0]), o = s.type === "atom" && s.family === "open" ? rr(s.text) : null, h = Ne(e[1]), c = h.type === "atom" && h.family === "close" ? rr(h.text) : null, p = H(e[2], "size"), g, y = null;
...
B({
  ...
  handler: (r5, e) => {
    var {
      parser: t,
      funcName: a
    } = r5, n = e[0], s = ka(H(e[1], "infix").size), o = e[2], h = s.number > 0;
    return {
      type: "genfrac",
      mode: t.mode,
      numer: n,
...
var me = (r5, e) => {
  var t;
  if (r5.symbol)
    t = new h0("mo", [v0(r5.name, r5.mode)]), q.contains(ta, r5.name) && t.setAttribute("largeop", "false");
  else if (r5.body)
    t = new h0("mo", o0(r5.body, e));
  else {
...
B({
  ...
  mathmlBuilder(r5, e) {
    var t = ir[r5.style], a = e.havingStyle(t), n = o0(r5.body, a), s = new S.MathNode("mstyle", n), o = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
  ...
  htmlBuilder(r5, e) {
    if (rt.hasOwnProperty(r5.text)) {
      ...
      if (tt.hasOwnProperty(r5.text))
        return b.makeSpan(["mspace", tt[r5.text]], [], e);
...
var hr = (r5) => r5.body.replace(/ /g, r5.star ? "␣" : " ");
var L0 = Tr;
var ia = `[ \r
	]`;
var e4 = "\\\\[a-zA-Z@]+";
...
?)[ \r	]*`;
var ct = "[̀-ͯ]";
var n4 = new RegExp(ct + "+$");
var i4 = "(" + ia + "+)|" + // whitespace
(a4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(ct + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
m("\\char", function(r5) {
  ...
  if (t) {
    ...
    for (var n; (n = cr[r5.future().text]) != null && n < t; )
      a *= t, a += n, r5.popToken();
  }
  return "\\@char{" + a + "}";
});
var Dt = (r5, e, t, a) => {
  ...
  if (n = r5.consumeArg().tokens, n.length === 1 && n[0].text === "[") {
    for (var c = "", p = r5.expandNextToken(); p.text !== "]" && p.text !== "EOF"; )
      c += p.text, p = r5.expandNextToken();
    if (!c.match(/^\s*[0-9]+\s*$/))
      throw new M("Invalid number of arguments: " + c);
    h = parseInt(c), n = r5.consumeArg().tokens;
  }
  return o && a || r5.macros.set(s, {
    tokens: n,
    numArgs: h
  }), "";
};
...
var He = class _He {
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (_He.endOfExpression.indexOf(n.text) !== -1 || t && n.text === t || e && L0[n.text] && L0[n.text].infix)
        break;
...
//# sourceMappingURL=katex-CUSbq6rG-JSN3E5DC.js.map
